...
class _MonthViewState extends State<_MonthView>
  ...
  NepaliDateTime _addMonthsToMonthDate(
    ...
    // print('monthdate => ${NepaliDateTime.now().month}');
  ...
  Widget _buildItems(BuildContext context, int index) {
    ...
    return _DaysView(
      ...
      prevMonth: month.month == 1
          ? NepaliDateTime(month.year - 1, 12)
          : NepaliDateTime(month.year, month.month - 1),
      nextMonth: month.month == 12
          ? NepaliDateTime(month.year + 1, 1)
          : NepaliDateTime(month.year, month.month + 1),
    );
  }
      ...
      child: Column(
        children: <Widget>[
          _CalendarHeader(
            ...
            changeToToday: () {
              widget.onChanged(NepaliDateTime.now().toLocal());
            },
