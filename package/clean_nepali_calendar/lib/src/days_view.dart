...
const double _kDayPickerRowHeight = 54.0;
...
class _DaysView extends StatelessWidget {
  ...
  final NepaliDateTime prevMonth;
  final NepaliDateTime nextMonth;
  ...
  Widget build(BuildContext context) {
    ...
    for (var i = 0; i <= 42; i++) {
      ...
      if (day < 1) {
        final dayToBuild =
            NepaliDateTime(prevMonth.year, prevMonth.month, prevDay);
        final text =
            '${language == Language.english ? prevDay : NepaliUnicode.convert('$prevDay')}';
        ...
        final tempDays = day - daysInMonth;
        final dayToBuild =
            NepaliDateTime(nextMonth.year, nextMonth.month, tempDays);
        final text =
            '${language == Language.english ? tempDays : NepaliUnicode.convert('$tempDays')}';
